        ...
        <div className="checkout-grid">
          ...
          <div className="order-summary">
            ...
            return (
              ...
              <div className="delivery-date">{dayjs(selectedDeliveryOption.estimatedDeliveryTimeMs).format('dddd, MMMM D')}</div>
                ...
                <div className="delivery-options">
                  ...
                  {deliveryOptions.map((deliveryOption)=>{
                   ...
                   <div key={deliveryOption.id} className="delivery-option">
                    ...
                    />
                    <div>
                      <div className="delivery-option-date">Tu{dayjs(deliveryOption.estimatedDeliveryTimeMs).format('dddd, MMMM D')}</div>
